        ...
        <nav className={`fixed  w-screen   transition-all ${pathname == '/Glosario' ? 'bg-[#2A52BE]'  : ''} z-40  ${show ? 'top-0' : 'top-[-100px]'} transition-all  ${ scrollY > 500 ? 'bg-[#101c3fd5] lg:border-b lg:border-gray-200' : ''}`}>
            ...
            <div className="w-screen flex items-center justify-between mx-auto py-4 px-4 lg:px-8 ">
               ...
               { pathname === '/Glosario' && <div className="relative w-[60vw] ">
                    <input type="search" id="location-search" onChange={handlerFilter} className="block p-3 w-full h-full z-20  placeholder-white text-sm   bg-[#7397e69d] rounded-[5px] focus:ring-blue-500 focus:border-blue-500 text-white" placeholder="Glosario" required />
